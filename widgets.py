...
class TodayLunch(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        sch.every().monday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[0]))
        sch.every().tuesday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[0]))
        sch.every().wednesday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[0]))
        sch.every().thursday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[0]))
        sch.every().friday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[0]))
