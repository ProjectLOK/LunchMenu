...
class NextdayLunch(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        sch.every().monday.at("12:10").do(lambda: self.cal.set(lunch_data.cal[2]))
        sch.every().tuesday.at("12:10").do(lambda: self.cal.set(lunch_data.cal[2]))
        sch.every().wednesday.at("12:10").do(lambda: self.cal.set(lunch_data.cal[2]))
        sch.every().thursday.at("12:10").do(lambda: self.cal.set(lunch_data.cal[2]))
        sch.every().friday.at("12:10").do(lambda: self.cal.set(lunch_data.cal[2]))
        ...
        sch.every().monday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[1]))
        sch.every().tuesday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[1]))
        sch.every().wednesday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[1]))
        sch.every().thursday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[1]))
        sch.every().friday.at("00:01").do(lambda: self.cal.set(lunch_data.cal[1]))
